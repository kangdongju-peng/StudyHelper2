...
class RingtoneService  : Service() {
    ...
    private fun fireNotification() {
        ...
        var pendingIntent : PendingIntent = PendingIntent.getActivity(this,0,main_activity_intent,0)
        ...
        var notification : Notification = NotificationCompat.Builder(this).setContentTitle("Alarm is going off")
